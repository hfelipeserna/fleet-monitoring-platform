...
// ---------------------------------------------------------------------------
// TEST-009 migration DDL fragments — file-read only, no DB (no //go:build integration)
// Covers [SPEC-001: AC-009, FR-010, BR-008] TEST-009 fragment: hypertable + PK + index + geom GENERATED
// ---------------------------------------------------------------------------

func TestTelemetryMigration_DDLFragments(t *testing.T) {
